export default function PrivacyPolicyPage() {
  return (
    <div className="pt-[110px] pr-[87px] pb-[127px] pl-[96px] overflow-auto">
      ...
      <br />
      <br />
      <h2 className="text-[27px] font-[700]">Interpretation and Definitions</h2>
      <br />
      <br />
      <h3 className="text-[20px] font-[700]">Interpretation</h3>
      <br />
      <br />
      <p>
      ...
      <br />
      <br />
      <h3 className="text-[20px] font-[700]">Definitions</h3>
      <br />
      <br />
      ...
      <br />
      <br />
      <h3 className="text-[20px] font-[700]">Use of Your Personal Data</h3>
      <br />
      <br />
      ...
      <br />
      <br />
      <h3 className="text-[20px] font-[700]">Transfer of Your Personal Data</h3>
      <br />
      <br />
      <p>
      ...
      <br />
      <br />
      <h3 className="text-[20px] font-[700]">Delete Your Personal Data</h3>
      <br />
      <br />
      <p>
      ...
      <br />
      <br />
      <h3 className="text-[20px] font-[700]">Security of Your Personal Data</h3>
      <br />
      <br />
      <p>
      ...
      <br />
      <br />
      <h2 className="text-[27px] font-[700]">Children&apos;s Privacy</h2>
      <br />
      <br />
      <p>
      ...
      <br />
      <br />
      <h2 className="text-[27px] font-[700]">Links to Other Websites</h2>
      <br />
      <br />
      <p>
      ...
      <br />
      <br />
      <h2 className="text-[27px] font-[700]">Changes to this Privacy Policy</h2>
      <br />
      <br />
      <p>
      ...
      <br />
      <br />
      <h2 className="text-[27px] font-[700]">Contact Us</h2>
      <br />
      <br />
      <p>
