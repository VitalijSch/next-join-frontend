export default function TodoIcon() {
  return (
    ...
    >
      <circle
        className="fill-[#2A3647] group-hover:fill-white transition-colors duration-300 ease-in-out"
        cx="34.5"
        cy="35"
        r="34.5"
      />
      <mask
        id="mask0_359461_6258"
      ...
      >
        <rect
          className="fill-white group-hover:fill-[#2A3647] transition-colors duration-300 ease-in-out"
          x="18.5"
          y="19"
          width="32"
          height="32"
